    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">辅导员名称</view>
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0 10rpx 0px rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"40rpx","borderWidth":"2rpx 2rpx 10rpx 2rpx","fontSize":"26rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.fudaoyuanName" type="text" v-model="ruleForm.fudaoyuanName" placeholder="辅导员名称"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">辅导员手机号</view>
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0 10rpx 0px rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"40rpx","borderWidth":"2rpx 2rpx 10rpx 2rpx","fontSize":"26rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.fudaoyuanPhone" type="text" v-model="ruleForm.fudaoyuanPhone" placeholder="辅导员手机号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">辅导员身份证号</view>
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0 10rpx 0px rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"40rpx","borderWidth":"2rpx 2rpx 10rpx 2rpx","fontSize":"26rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.fudaoyuanIdNumber" type="text" v-model="ruleForm.fudaoyuanIdNumber" placeholder="辅导员身份证号"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="fudaoyuanPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">辅导员头像</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.fudaoyuanPhoto" :src="baseUrl+ruleForm.fudaoyuanPhoto" mode="aspectFill">
                        </image>
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">辅导员邮箱</view>
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0 10rpx 0px rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"40rpx","borderWidth":"2rpx 2rpx 10rpx 2rpx","fontSize":"26rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.fudaoyuanEmail" type="text" v-model="ruleForm.fudaoyuanEmail" placeholder="辅导员邮箱"></input>
            </view>
    ...
    export default {
		...
		/*下拉框*/
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`fudaoyuan`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.fudaoyuanId){
                this.ruleForm.fudaoyuanId = options.fudaoyuanId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.fudaoyuanName)) {
                    this.$utils.msg(`辅导员名称不能为空`);
                    return
                }
				if ((!this.ruleForm.fudaoyuanPhone) && (!this.$validate.isMobile(this.ruleForm.fudaoyuanPhone))) {
                    this.$utils.msg(`辅导员手机号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.fudaoyuanIdNumber) && (!this.$validate.checkIdCard(this.ruleForm.fudaoyuanIdNumber))) {
                    this.$utils.msg(`辅导员身份证号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.fudaoyuanPhoto)) {
                    this.$utils.msg(`辅导员头像不能为空`);
                    return
                }
				...
				if ((!this.ruleForm.fudaoyuanEmail) && (!this.$validate.isEmail(this.ruleForm.fudaoyuanEmail))) {
                    this.$utils.msg(`辅导员邮箱不能为空并且需要输入正确格式`);
                    return
                }
                if (this.ruleForm.id) {
                    await this.$api.update(`fudaoyuan`, this.ruleForm);
                } else {
                    await this.$api.save(`fudaoyuan`, this.ruleForm);
                }
