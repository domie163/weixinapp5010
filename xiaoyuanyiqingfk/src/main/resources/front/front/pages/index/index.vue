    ...
    <block v-for="(item,index) in newsList" :key="index">
        ...
        <view class="listBox recommend">
                ...
                <view class="title"
                    ...
                    <text
                            :style='{"padding":"0 20rpx 0 0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"var(--publicSubColor)","color":"rgba(0, 0, 0, 1)","textAlign":"right","borderRadius":"0 20rpx 0 0","borderWidth":"0","width":"45%","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}'
                            @tap="onPageTap('meirixinxi')">查看更多
                    </text>
                </view>
<view v-if='2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''" :style='{"borderRadius":"0","backgroundColor":"#efefef"}'>
    <view @tap="onDetailTap('meirixinxi',product.id)" :style='{"borderRadius":"8rpx","backgroundColor":"#fff"}' class="uni-product" v-for="(product,index) in meirixinxiList" :key="index">
        <view :style='{"fontSize":"28rpx","lineHeight":"56rpx","color":"var(--publicMainColor)","textAlign":"center"}' class="uni-product-title">{{product.meirixinxiName}}</view>
        <view class="image-view" :style='{"borderRadius":"2rpx","height":"180rpx"}'>
            <image :style='{"borderRadius":"2rpx","height":"180rpx"}' mode="aspectFill" class="uni-product-image" :src="baseUrl+product.meirixinxiPhoto"></image>
        </view>
    </view>
</view>
        </view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let meirixinxi = await this.$api.list('meirixinxi', {
                page: 1,
                limit: 6,
                yonghuDelete: 1,
                });

            this.meirixinxiList = meirixinxi.data.list
            this.meirixinxiList.forEach(function(item, index) {
