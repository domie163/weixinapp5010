	...
	<view>
        ...
        <view class="username">
			<text v-if="forum.yonghuId != null">
				 发布人：{{forum.yonghuName}}（防疫人员）
			</text>
			<text v-if="forum.fudaoyuanId != null">
				 发布人：{{forum.fudaoyuanName}}（辅导员）
			</text>
			...
			<view class="uni-article__comment-box" v-for="comment in commentData" :key="comment.id" >
				<view class="article-meta">
					<view class="article-header-image">
                        ...
                        <image v-if="comment.fudaoyuanId != null" class="image" :src="baseUrl+comment.fudaoyuanPhoto" mode="widthFix"></image>
					...
					<view class="article-header-content">
						<view class="article-header-title">
							...
							<text v-if="comment.fudaoyuanId != null">{{comment.fudaoyuanName}}</text>
