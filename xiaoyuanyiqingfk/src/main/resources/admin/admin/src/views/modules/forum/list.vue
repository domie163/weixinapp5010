            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.fudaoyuanId">
                            辅导员
                        </span>
...
|| (sessionTable == 'fudaoyuan' && scope.row.fudaoyuanId ==userId)
        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '辅导员名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.fudaoyuanName" placeholder="辅导员名称" clearable></el-input>
                    </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanyiqingfk/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.fudaoyuanId = el.fudaoyuanId;//---
                            forum.fudaoyuanName = el.fudaoyuanName;
                            forum.fudaoyuanPhone = el.fudaoyuanPhone;
                            forum.fudaoyuanIdNumber = el.fudaoyuanIdNumber;
                            forum.fudaoyuanPhoto = el.fudaoyuanPhoto;
                            forum.fudaoyuanEmail = el.fudaoyuanEmail;
                            forum.fudaoyuanDelete = el.fudaoyuanDelete;
