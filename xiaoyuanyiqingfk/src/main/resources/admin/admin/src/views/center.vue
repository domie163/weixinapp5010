<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='fudaoyuan'"  label='辅导员名称' prop="fudaoyuanName">
               <el-input v-model="ruleForm.fudaoyuanName"  placeholder='辅导员名称' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='fudaoyuan'"  label='辅导员邮箱' prop="fudaoyuanEmail">
               <el-input v-model="ruleForm.fudaoyuanEmail"  placeholder='辅导员邮箱' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='防疫人员名称' prop="yonghuName">
               <el-input v-model="ruleForm.yonghuName"  placeholder='防疫人员名称' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='防疫人员手机号' prop="yonghuPhone">
               <el-input v-model="ruleForm.yonghuPhone"  placeholder='防疫人员手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='防疫人员身份证号' prop="yonghuIdNumber">
               <el-input v-model="ruleForm.yonghuIdNumber"  placeholder='防疫人员身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'" label='防疫人员头像' prop="yonghuPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='防疫人员邮箱' prop="yonghuEmail">
               <el-input v-model="ruleForm.yonghuEmail"  placeholder='防疫人员邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
